...
<p align="center">
  <img src="tech_stack_banner.png" alt="Oyster AI Tech Stack Banner" width="100%" />
</p>
...
<p align="center">
  <img src="3.png" alt="Oyster AI Landing Page" width="85%" style="border-radius: 8px; border: 1px solid var(--border-light);" />
</p>
...
<p align="center">
  <img src="5.png" alt="Oyster AI Operations Dashboard" width="85%" style="border-radius: 8px; border: 1px solid var(--border-light);" />
</p>
...
<p align="center">
  <img src="1.png" alt="Oyster AI Data Sources" width="85%" style="border-radius: 8px; border: 1px solid var(--border-light);" />
</p>
...
<p align="center">
  <img src="4.png" alt="Oyster AI Workflow Builder" width="85%" style="border-radius: 8px; border: 1px solid var(--border-light);" />
</p>
...
<p align="center">
  <img src="2.png" alt="Oyster AI Performance Analytics" width="85%" style="border-radius: 8px; border: 1px solid var(--border-light);" />
</p>
...
<p align="center">
  <img src="screen.png" alt="Oyster AI System Alerts" width="85%" style="border-radius: 8px; border: 1px solid var(--border-light);" />
</p>
...
Oyster AI adheres to a strict **"Tactile Precision"** design philosophy defined in `oyster-ai/src/index.css`. The branding avoids generic modern UI trends in favor of an editorial-style museum layout.
...
### Installation
Clone the repository and navigate to the application directory, then install the dependencies:
```bash
cd oyster-ai
npm install
```
